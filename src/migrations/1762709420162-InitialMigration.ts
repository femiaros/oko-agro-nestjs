...
export class InitialMigration1762709420162 implements MigrationInterface {
    name = 'InitialMigration1762709420162'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "phoneNumber" character varying NOT NULL, "farmAddress" character varying, "country" character varying, "state" character varying, "farmName" character varying, "farmSize" character varying, "farmSizeUnit" "public"."users_farmsizeunit_enum", "estimatedAnnualProduction" character varying, "farmingExperience" character varying, "internetAccess" character varying, "howUserSellCrops" character varying, "bankName" character varying, "accountNumber" character varying, "role" "public"."users_role_enum" NOT NULL, "companyName" character varying, "businessRegNumber" character varying, "yearEstablished" character varying, "businessType" "public"."users_businesstype_enum", "processsingCapacitySize" character varying, "processsingCapacityUnit" "public"."users_processsingcapacityunit_enum", "operatingDaysPerWeek" "public"."users_operatingdaysperweek_enum", "storageCapacity" character varying, "minimumOrderQuality" character varying, "OperationsType" character varying, "userVerified" boolean NOT NULL DEFAULT false, "userVerificationOtp" character varying, "userVerificationOtpExpiryTime" TIMESTAMP WITH TIME ZONE, "passwordResetToken" character varying, "passwordResetExpiryTime" TIMESTAMP WITH TIME ZONE, "passwordChangedAt" TIMESTAMP WITH TIME ZONE, "isDeleted" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
